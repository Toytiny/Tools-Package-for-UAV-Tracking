...
function run_group_OTB100(save_dir)                                        % 没有输入，则默认保存在当前文件下下的\all_trk_results\
%%  读取视频序列和groundtruth
...
run_trackers_info = struct('STAPLE',@run_STAPLE);                               % 获取运行tracker的函数信息，函数最好是run_xxx(seq, res_path, bSaveImage))这种
