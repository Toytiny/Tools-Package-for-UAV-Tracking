...
function LoopsOnOTB100(save_dir)                                        % 没有输入，则默认保存在当前文件下下的\loop_results\
%%  读取视频序列和groundtruth
...
run_trackers_info = struct('STAPLE',@run_STAPLE);           %需要调参的tracker
...
if nargin < 1
    save_dir = [main_folder '\loop_results\OTB100\'];              % 保存跑完的结果到指定文件夹
end
